...
public class ResultSetSpy implements ResultSet, Spy {
     ...
     * 
     * @param methodCall
     *            description of method call and arguments passed to it that
     ...
     *            returned.
     * @param msg
     *            description of what the return value that was returned. may be
    ...
    public void updateAsciiStream(String columnName, InputStream x, int length)
            throws SQLException {
        String methodCall = "updateAsciiStream(" + columnName + ", " + x + ", "
                + length + ")";
        try {
    ...
    public Time getTime(int columnIndex) throws SQLException {
        ...
        try {
            return (Time) reportReturn(methodCall,
    ...
    public Time getTime(String columnName) throws SQLException {
        ...
        try {
            return (Time) reportReturn(methodCall,
                    realResultSet.getTime(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Time getTime(int columnIndex, Calendar cal) throws SQLException {
        ...
        try {
            return (Time) reportReturn(methodCall,
                    realResultSet.getTime(columnIndex, cal));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Time getTime(String columnName, Calendar cal) throws SQLException {
        ...
        try {
            return (Time) reportReturn(methodCall,
                    realResultSet.getTime(columnName, cal));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Timestamp getTimestamp(int columnIndex) throws SQLException {
        ...
        try {
            return (Timestamp) reportReturn(methodCall,
                    realResultSet.getTimestamp(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Timestamp getTimestamp(String columnName) throws SQLException {
        ...
        try {
            return (Timestamp) reportReturn(methodCall,
                    realResultSet.getTimestamp(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Timestamp getTimestamp(int columnIndex, Calendar cal)
        ...
        try {
            return (Timestamp) reportReturn(methodCall,
                    realResultSet.getTimestamp(columnIndex, cal));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Timestamp getTimestamp(String columnName, Calendar cal)
        ...
        try {
            return (Timestamp) reportReturn(methodCall,
                    realResultSet.getTimestamp(columnName, cal));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Blob getBlob(String colName) throws SQLException {
        ...
        try {
            return (Blob) reportReturn(methodCall,
                    realResultSet.getBlob(colName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Clob getClob(String colName) throws SQLException {
        ...
        try {
            return (Clob) reportReturn(methodCall,
                    realResultSet.getClob(colName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public boolean getBoolean(int columnIndex) throws SQLException {
        ...
        try {
            return reportReturn(methodCall,
                    realResultSet.getBoolean(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public boolean getBoolean(String columnName) throws SQLException {
        ...
        try {
            return reportReturn(methodCall,
                    realResultSet.getBoolean(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Array getArray(String colName) throws SQLException {
        ...
        try {
            return (Array) reportReturn(methodCall,
                    realResultSet.getArray(colName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public RowId getRowId(int columnIndex) throws SQLException {
        ...
        try {
            return (RowId) reportReturn(methodCall,
    ...
    public RowId getRowId(String columnLabel) throws SQLException {
        ...
        try {
            return (RowId) reportReturn(methodCall,
                    realResultSet.getRowId(columnLabel));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public NClob getNClob(int columnIndex) throws SQLException {
        ...
        try {
            return (NClob) reportReturn(methodCall,
                    realResultSet.getNClob(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public NClob getNClob(String columnLabel) throws SQLException {
        ...
        try {
            return (NClob) reportReturn(methodCall,
                    realResultSet.getNClob(columnLabel));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public SQLXML getSQLXML(int columnIndex) throws SQLException {
        ...
        try {
            return (SQLXML) reportReturn(methodCall,
                    realResultSet.getSQLXML(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public SQLXML getSQLXML(String columnLabel) throws SQLException {
        ...
        try {
            return (SQLXML) reportReturn(methodCall,
                    realResultSet.getSQLXML(columnLabel));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public String getNString(int columnIndex) throws SQLException {
        ...
        try {
            return (String) reportReturn(methodCall,
                    realResultSet.getNString(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public String getNString(String columnLabel) throws SQLException {
        ...
        try {
            return (String) reportReturn(methodCall,
                    realResultSet.getNString(columnLabel));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Reader getNCharacterStream(int columnIndex) throws SQLException {
        ...
        try {
            return (Reader) reportReturn(methodCall,
                    realResultSet.getNCharacterStream(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Reader getNCharacterStream(String columnLabel) throws SQLException {
        ...
        try {
            return (Reader) reportReturn(methodCall,
                    realResultSet.getNCharacterStream(columnLabel));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public void updateNCharacterStream(int columnIndex, Reader x, long length)
            throws SQLException {
        String methodCall = "updateNCharacterStream(" + columnIndex + ", " + x
                + ", " + length + ")";
        try {
    ...
    public void updateNCharacterStream(String columnLabel, Reader reader,
        ...
        String methodCall = "updateNCharacterStream(" + columnLabel + ", "
                + reader + ", " + length + ")";
        try {
    ...
    public void updateCharacterStream(String columnLabel, Reader reader,
            long length) throws SQLException {
        String methodCall = "updateCharacterStream(" + columnLabel + ", "
                + reader + ", " + length + ")";
        try {
    ...
    public void updateNCharacterStream(int columnIndex, Reader reader)
            throws SQLException {
        String methodCall = "updateNCharacterStream(" + columnIndex + ", "
                + reader + ")";
        try {
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        ...
        try {
            return (ResultSetMetaData) reportReturn(methodCall,
                    realResultSet.getMetaData());
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public double getDouble(int columnIndex) throws SQLException {
        ...
        try {
            return reportReturn(methodCall,
                    realResultSet.getDouble(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Date getDate(int columnIndex) throws SQLException {
        ...
        try {
            return (Date) reportReturn(methodCall,
                    realResultSet.getDate(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Date getDate(String columnName) throws SQLException {
        ...
        try {
            return (Date) reportReturn(methodCall,
                    realResultSet.getDate(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Date getDate(int columnIndex, Calendar cal) throws SQLException {
        ...
        try {
            return (Date) reportReturn(methodCall,
                    realResultSet.getDate(columnIndex, cal));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Date getDate(String columnName, Calendar cal) throws SQLException {
        ...
        try {
            return (Date) reportReturn(methodCall,
                    realResultSet.getDate(columnName, cal));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Object getObject(int columnIndex) throws SQLException {
        ...
        try {
            return reportReturn(methodCall,
                    realResultSet.getObject(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Object getObject(String colName, Map map) throws SQLException {
        ...
        try {
            return reportReturn(methodCall,
                    realResultSet.getObject(colName, map));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Object getObject(int columnIndex, Map<String, Class<?>> map)
        ...
        try {
            return reportReturn(methodCall,
                    realResultSet.getObject(columnIndex, map));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public InputStream getAsciiStream(int columnIndex) throws SQLException {
        ...
        try {
            return (InputStream) reportReturn(methodCall,
                    realResultSet.getAsciiStream(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public InputStream getAsciiStream(String columnName) throws SQLException {
        ...
        try {
            return (InputStream) reportReturn(methodCall,
                    realResultSet.getAsciiStream(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public URL getURL(int columnIndex) throws SQLException {
        ...
        try {
            return (URL) reportReturn(methodCall,
                    realResultSet.getURL(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public URL getURL(String columnName) throws SQLException {
        ...
        try {
            return (URL) reportReturn(methodCall,
                    realResultSet.getURL(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public InputStream getUnicodeStream(int columnIndex) throws SQLException {
        ...
        try {
            return (InputStream) reportReturn(methodCall,
                    realResultSet.getUnicodeStream(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public InputStream getUnicodeStream(String columnName) throws SQLException {
        ...
        try {
            return (InputStream) reportReturn(methodCall,
                    realResultSet.getUnicodeStream(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public SQLWarning getWarnings() throws SQLException {
        ...
        try {
            return (SQLWarning) reportReturn(methodCall,
                    realResultSet.getWarnings());
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public InputStream getBinaryStream(int columnIndex) throws SQLException {
        ...
        try {
            return (InputStream) reportReturn(methodCall,
                    realResultSet.getBinaryStream(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public InputStream getBinaryStream(String columnName) throws SQLException {
        ...
        try {
            return (InputStream) reportReturn(methodCall,
                    realResultSet.getBinaryStream(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public int findColumn(String columnName) throws SQLException {
        ...
        try {
            return reportReturn(methodCall,
                    realResultSet.findColumn(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public void updateBinaryStream(String columnName, InputStream x, int length)
            throws SQLException {
        String methodCall = "updateBinaryStream(" + columnName + ", " + x
                + ", " + length + ")";
        try {
    ...
    public String getString(String columnName) throws SQLException {
        ...
        try {
            return (String) reportReturn(methodCall,
                    realResultSet.getString(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Reader getCharacterStream(int columnIndex) throws SQLException {
        ...
        try {
            return (Reader) reportReturn(methodCall,
                    realResultSet.getCharacterStream(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Reader getCharacterStream(String columnName) throws SQLException {
        ...
        try {
            return (Reader) reportReturn(methodCall,
                    realResultSet.getCharacterStream(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public void updateCharacterStream(String columnName, Reader reader,
        ...
        String methodCall = "updateCharacterStream(" + columnName + ", "
                + reader + ", " + length + ")";
        try {
    ...
    public byte[] getBytes(int columnIndex) throws SQLException {
        ...
        try {
            return (byte[]) reportReturn(methodCall,
                    realResultSet.getBytes(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public byte[] getBytes(String columnName) throws SQLException {
        ...
        try {
            return (byte[]) reportReturn(methodCall,
                    realResultSet.getBytes(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public BigDecimal getBigDecimal(int columnIndex, int scale)
        ...
        try {
            return (BigDecimal) reportReturn(methodCall,
                    realResultSet.getBigDecimal(columnIndex, scale));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public BigDecimal getBigDecimal(String columnName, int scale)
        ...
        try {
            return (BigDecimal) reportReturn(methodCall,
                    realResultSet.getBigDecimal(columnName, scale));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
        ...
        try {
            return (BigDecimal) reportReturn(methodCall,
                    realResultSet.getBigDecimal(columnIndex));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public BigDecimal getBigDecimal(String columnName) throws SQLException {
        ...
        try {
            return (BigDecimal) reportReturn(methodCall,
                    realResultSet.getBigDecimal(columnName));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return (T) reportReturn(
                    methodCall,
                    (iface != null && (iface == ResultSet.class || iface == Spy.class)) ? (T) this
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        String methodCall = "isWrapperFor("
                + (iface == null ? "null" : iface.getName()) + ")";
        try {
            return reportReturn(
                    methodCall,
